...
namespace MyApi.Migrations
{
    ...
    [Migration("20260420064748_RenameCompanyPasswordToPasswordHash")]
    partial class RenameCompanyPasswordToPasswordHash
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApi.Models.PlannedShifts", b =>
                {
                    b.Property<int>("PlannedShiftsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlannedShiftsID"));

                    b.Property<int>("ShiftRequestID")
                        .HasColumnType("int");

                    b.Property<DateOnly>("approx_date")
                        .HasColumnType("date");

                    b.Property<int>("approx_duration")
                        .HasColumnType("int");

                    b.Property<TimeOnly>("approx_start_time")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("MyApi.Models.Ratings", b =>
                {
            ...
            modelBuilder.Entity("MyApi.Models.ShiftRequest", b =>
                {
                    ...
                    b.HasOne("MyApi.Models.Administration", "Rem")
                        .WithMany()
                        .HasForeignKey("RemId")
                        .OnDelete(DeleteBehavior.SetNull);
